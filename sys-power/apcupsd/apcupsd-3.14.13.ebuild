...
src_prepare() {
	...
	cp "${FILESDIR}/apcupsd.init.in" "${S}/platforms/gentoo/apcupsd.in" || die "cp failed"
	cp "${FILESDIR}/apcupsd-powerfail.init.in" "${S}/platforms/gentoo/apcupsd-powerfail.in" || die "cp failed"
	epatch "${FILESDIR}/${P}-added-powerfail.patch"
}
